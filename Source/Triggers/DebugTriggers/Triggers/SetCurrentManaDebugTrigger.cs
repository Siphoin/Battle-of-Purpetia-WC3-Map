...
{
    // Триггер для установки текущей маны
    public class SetCurrentManaDebugTrigger : TriggerInstance
    {
        ...
        public override trigger GetTrigger()
        {
            ...
            debugTrigger.RegisterPlayerChatEvent(Player(0), "SetMana", false);
