...
{
    // Триггер для установки максимальной маны
    public class SetMaxManaDebugTrigger : TriggerInstance
    {
        ...
        public override trigger GetTrigger()
        {
            ...
            debugTrigger.RegisterPlayerChatEvent(Player(0), "SetMaxMana", false);
